...
pub fn init(whiteboard_manager: Weak<WhiteboardManager>) -> AFPlugin {
  AFPlugin::new()
    ...
    .event(
      WhiteboardEvent::GetWhiteboardData,
      get_whiteboard_data_handler,
    )
    ...
    .event(
      WhiteboardEvent::ForceSaveWhiteboard,
      force_save_whiteboard_handler,
    )
    .event(
      WhiteboardEvent::GetWhiteboardJsonData,
      get_whiteboard_json_data_handler,
    )
}
