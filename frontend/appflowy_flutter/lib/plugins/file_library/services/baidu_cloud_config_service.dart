  ...
  Future<void> loadConfig() async {
    ...
    try {
      ...
      try {
        ...
        debugPrint('✅ 从Flutter资源系统加载百度网盘配置成功');
      } catch (e) {
        debugPrint('⚠️ 无法从Flutter资源系统加载.env.baidu: $e');
        ...
        if (configFile != null) {
          ...
          debugPrint('✅ 从文件系统加载百度网盘配置成功: ${configFile.path}');
        }
      }
      ...
      if (content != null) {
        ...
        _isLoaded = true;
        debugPrint('✅ 百度网盘配置解析成功');
      } else {
        debugPrint('⚠️ 百度网盘配置文件未找到');
        debugPrint('📝 请确保.env.baidu文件存在并包含在Flutter资源中');
      }
    } catch (e) {
      debugPrint('❌ 加载百度网盘配置失败: $e');
    }
  }
