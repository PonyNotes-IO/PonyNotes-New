  ...
  Widget buildEditorPage(
    ...
    if (UniversalPlatform.isMobile) {
      ...
      child = BlocBuilder<DocumentAppearanceCubit, DocumentAppearance>(
        builder: (context, appearanceState) => EditorDropHandler(
          viewId: widget.view.id,
          editorState: editorState,
          isLocalMode: context.read<DocumentBloc>().isLocalMode,
          child: AppFlowyEditorPage(
            key: ValueKey(
              'desktop_editor_${widget.view.id}_${appearanceState.fontSize}_${appearanceState.fontFamily}_${appearanceState.width}',
            ),
            editorState: editorState,
            // if the view's name is empty, focus on the title
            autoFocus: widget.view.name.isEmpty ? false : null,
              ...
              children: [
                ...
                if (effectiveViewInfoBloc != null)
                  MoreViewActions(
                    ...
                    pageAccessLevelBloc: _pageAccessLevelBlocForCurrentView(
                      context,
                    ),
                  )
                else
        ...
        children: [
          ...
          if (effectiveViewInfoBloc != null)
            MoreViewActions(
              view: widget.view,
              viewInfoBloc: effectiveViewInfoBloc,
              pageAccessLevelBloc: _pageAccessLevelBlocForCurrentView(context),
            )
          else
            MoreViewActions(
              view: widget.view,
