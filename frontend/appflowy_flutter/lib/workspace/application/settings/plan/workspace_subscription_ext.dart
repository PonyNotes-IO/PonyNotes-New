...
extension SubscriptionInfoHelpers on WorkspaceSubscriptionInfoPB {
  String get label => switch (plan) {
        WorkspacePlanPB.FreePlan => LocaleKeys.settings_planPage_planUsage_currentPlan_freeTitle.tr(),
        WorkspacePlanPB.StandPlan => LocaleKeys.settings_planPage_planUsage_currentPlan_standardTitle.tr(),
        WorkspacePlanPB.ProPlan => '专业版',
        WorkspacePlanPB.HiclassPlan => '高级版',
        _ => 'N/A',
      };

  String get info => switch (plan) {
        WorkspacePlanPB.FreePlan => LocaleKeys.settings_planPage_planUsage_currentPlan_freeInfo.tr(),
        WorkspacePlanPB.StandPlan => LocaleKeys.settings_planPage_planUsage_currentPlan_standardInfo.tr(),
        WorkspacePlanPB.ProPlan => '',
        WorkspacePlanPB.HiclassPlan => '',
        _ => 'N/A',
      };
...
/// 按枚举判断，Free=0, Stand=1, Pro=2, Hiclass=3
extension AllSubscriptionLabels on SubscriptionPlanPB {
  String get label => switch (this) {
        SubscriptionPlanPB.Free => LocaleKeys.settings_planPage_planUsage_currentPlan_freeTitle.tr(),
        SubscriptionPlanPB.Stand => LocaleKeys.settings_planPage_planUsage_currentPlan_standardTitle.tr(),
        SubscriptionPlanPB.Pro => '专业版',
        SubscriptionPlanPB.Hiclass => '高级版',
        _ => 'N/A',
      };
}
