...
class DateTimePage extends StatelessWidget {
  ...
  static const routeName = '/settings/datetime';

  @override
  Widget build(BuildContext context) {
    return const _DateTimePageContent();
  }
}

class _DateTimePageContent extends StatelessWidget {
  const _DateTimePageContent();
                  ...
                  MobileSettingGroup(
                    ...
                    settingItemList: [
                      MobileSettingRow(
                        ...
                        onTap: () =>
                            _showDateFormatPicker(context, state.dateFormat),
                      ),
                    ],
                    wrapInCard: true,
                    showDivider: false,
