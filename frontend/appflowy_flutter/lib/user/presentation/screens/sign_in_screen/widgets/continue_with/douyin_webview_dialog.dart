                      ...
                      try {
                        return Stack(
                          children: [
                            InAppWebView(
                              initialUrlRequest:
                                  URLRequest(url: WebUri(widget.authUrl)),
                              ...
                              onUpdateVisitedHistory:
                                ...
                                try {
                                  ...
                                  // 静默处理错误，避免崩溃
                                  Log.error(
                                    'DouYin WebView onUpdateVisitedHistory error: $e',
                                  );
                                }
                              },
                              onLoadHttpError:
                              ...
                              onPermissionRequest: (controller, request) async {
                                ...
                                return Future.microtask(() {
                                  try {
                                    ...
                                    Log.error(
                                      'DouYin WebView onPermissionRequest error: $e',
                                      stackTrace,
                                    );
                                    // 如果出错，拒绝权限请求
                                    return PermissionResponse(
                              ...
                              shouldOverrideUrlLoading:
                                ...
                                try {
                                  ...
                                  if (isCallback) {
                                    ...
                                    if (code != null && code.isNotEmpty) {
                                      ...
                                      if (state == widget.state ||
                                        ...
                                        Log.warn(
                                          'DouYin callback: state mismatch, but returning code anyway',
                                        );
                                        if (mounted) {
                                          Navigator.of(context).pop(code);
                                        }
                                  ...
                                  Log.error(
                                    'DouYin WebView shouldOverrideUrlLoading error: $e',
                                  );
                                  return NavigationActionPolicy.ALLOW;
                                }
                              },
                        ...
                        Log.error(
                          'DouYin WebView initialization error: $e',
                        );
                        return Center(
                          child: Column(
                            mainAxisSize: MainAxisSize.min,
